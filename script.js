...
const suspects = [
  {
    name: "Johnny 'Quick-Draw' Malone",
    backstory: `
      Johnny, a former street racer, became the go-to getaway driver for heists across the state. 
      Known for his cool demeanor and sharp instincts, Johnny’s ability to vanish into thin air made him a legend.
  ...
  {
    name: "Maggie 'Locks' O'Hara",
    backstory: `
      Maggie is a seasoned safecracker with a knack for finding vulnerabilities in any security system. 
  ...
  {
    name: "Benny 'Brains' Kaufman",
    backstory: `
      Benny, the mastermind behind the heist, had spent months meticulously planning every detail. 
      His obsession with control made him indispensable—but it also earned him enemies within the crew. 
      Recently, Benny’s obsession with perfection turned into paranoia, causing rifts among the team.
    `,
    clues: [
      ...
      "Handwriting on the stolen vault plan didn’t perfectly match Benny’s usual script."
    ]
  },
  {
    name: "Ruby 'Red' Rivera",
    backstory: `
      Ruby, a con artist with a flair for the dramatic, handled disguises and misdirection during the heist. 
      Her charm was her weapon, and she had a knack for making people look the other way. 
      Yet, Ruby’s growing frustration with her role in the crew—and her frequent disappearances—raised suspicions.
    `,
    clues: [
  ...
  {
    name: "Frank 'Muscles' Torino",
    backstory: `
      Frank, the enforcer of the group, was responsible for keeping the guards and any resistance in check. 
      A former boxer with a notorious temper, Frank’s loyalty to the crew had never been questioned—until rumors of a personal vendetta against Benny surfaced.
    `,
    clues: [
  ...
  {
    name: "Charlie 'The Inside Man' Banks",
    backstory: `
      Charlie, a disgruntled bank employee, was the one who leaked critical details about the vault layout. 
      Though his insider knowledge was invaluable, Charlie’s erratic behavior in the days leading up to the heist made others wary of him.
    `,
    clues: [
  ...
  {
    name: "Diana 'The Planner' Sharp",
    backstory: `
      Diana, a brilliant tactician, orchestrated the crew's escape routes and contingency plans. 
      She was always three steps ahead—except when it came to dealing with pressure. 
      Lately, Diana’s behavior had become erratic, sparking rumors of a secret agenda.
    `,
    clues: [
  ...
  {
    name: "Victor 'The Decoy' West",
    backstory: `
      Victor was the distraction, creating chaos to draw attention away from the heist. 
      A former street performer, his flair for theatrics was unmatched. 
      But Victor’s habit of improvising during critical moments left the crew on edge.
    `,
    clues: [
